...
- [http\_logviewer](#http_logviewer)
  ...
  - [API Overview](#api-overview)
    - [1. Core Log Entry Models](#1-core-log-entry-models)
    - [2. Threat and Actor Domain Models](#2-threat-and-actor-domain-models)
      - [Terminal Demonstration](#terminal-demonstration)
    - [3. Configuration and State Models](#3-configuration-and-state-models)
      - [Terminal Demonstration](#terminal-demonstration-1)
    - [4. Log Format Detection \& Parsers](#4-log-format-detection--parsers)
      - [Terminal Demonstration](#terminal-demonstration-2)
    - [5. Streaming Ingestion \& Pipe Support](#5-streaming-ingestion--pipe-support)
      - [Terminal Demonstration](#terminal-demonstration-3)
    - [6. Parsing Fault-Tolerance \& Edge Cases](#6-parsing-fault-tolerance--edge-cases)
      - [Terminal Demonstration](#terminal-demonstration-4)
    - [7. IP-to-Country Lookup \& GeoIP Enrichment](#7-ip-to-country-lookup--geoip-enrichment)
      - [Terminal Demonstration](#terminal-demonstration-5)
    - [8. Unicode Regional Indicator Flags \& Country Metadata](#8-unicode-regional-indicator-flags--country-metadata)
      - [Terminal Demonstration](#terminal-demonstration-6)
    - [9. Bogon, Private, and Loopback IP Handling](#9-bogon-private-and-loopback-ip-handling)
      - [Terminal Demonstration](#terminal-demonstration-7)
    - [10. Attack Signature \& Payload Detection](#10-attack-signature--payload-detection)
      - [Terminal Demonstration](#terminal-demonstration-8)
    - [11. User-Agent Taxonomy \& Bot Identification](#11-user-agent-taxonomy--bot-identification)
      - [Terminal Demonstration](#terminal-demonstration-9)
    - [12. Behavioral Heuristics \& Anomaly Scoring](#12-behavioral-heuristics--anomaly-scoring)
      - [Terminal Demonstration](#terminal-demonstration-10)
    - [13. Actor Fingerprint Synthesis \& Multi-IP Correlation](#13-actor-fingerprint-synthesis--multi-ip-correlation)
      - [Terminal Demonstration](#terminal-demonstration-11)
    - [14. Multi-IP Probe Sequence Correlation](#14-multi-ip-probe-sequence-correlation)
    - [15. Subnet, ASN \& Temporal Clustering](#15-subnet-asn--temporal-clustering)
    - [16. Background-Colored HTTP Status Highlighting](#16-background-colored-http-status-highlighting)
    - [17. Streaming Log Output \& Formatted Tables](#17-streaming-log-output--formatted-tables)
    - [18. Grouped Actor View \& Anomaly Drill-down](#18-grouped-actor-view--anomaly-drill-down)
    - [19. CLI Options \& Argument Parser](#19-cli-options--argument-parser)
    - [20. Public Library API \& Programmatic Consumption](#20-public-library-api--programmatic-consumption)
    - [21. End-to-End Pipeline \& Sample Log Fixtures](#21-end-to-end-pipeline--sample-log-fixtures)
      - [Terminal Demonstration](#terminal-demonstration-12)
    - [22. Idiomatic Nim \& Architectural Integrity](#22-idiomatic-nim--architectural-integrity)
      - [Terminal Demonstration](#terminal-demonstration-13)
    - [23. Memory Safety \& Allocation Profiling](#23-memory-safety--allocation-profiling)
      - [Terminal Demonstration](#terminal-demonstration-14)
    - [24. Threat Detection Accuracy \& False Positive Auditing](#24-threat-detection-accuracy--false-positive-auditing)
      - [Terminal Demonstration](#terminal-demonstration-15)
    - [25. Performance Benchmarking \& Release Gate Review](#25-performance-benchmarking--release-gate-review)
      - [Terminal Demonstration](#terminal-demonstration-16)
  - [Examples](#examples)
